            ...
            <ul className="right-navbar">
              <li>
                <button className="switch-btn">
                  <span className="switch-inside"></span>
                </button>
              </li>
              ...
              <li tabIndex={0} className="notification">
                ...
                <div className="noti-quantities">3</div>
                <div className="noti-list">
                  <ul className="noti-ul">
                    <li>
                      <span className="noti-img padding">
                        <img
                          src="https://gogo-react.coloredstrategies.com/assets/img/profiles/l-2.jpg"
                          alt=""
                        />
                      </span>
                    ...
                    <li>
                      <span className="noti-img padding">
                        <img
                          src="https://gogo-react.coloredstrategies.com/assets/img/notifications/thumb-1.jpg"
                          alt=""
                        />
                      </span>
                      <div className="noti-content padding">
                    ...
                    <li>
                      <span className="noti-img padding">
                        <img
                          src="https://gogo-react.coloredstrategies.com/assets/img/notifications/thumb-2.jpg"
                          alt=""
                        />
                      </span>
                      <div className="noti-content padding">
                    ...
                    <li>
                      <span className="noti-img padding">
                        <img
                          src="https://gogo-react.coloredstrategies.com/assets/img/notifications/thumb-3.jpg"
                          alt=""
                        />
                      </span>
                      <div className="noti-content padding">
