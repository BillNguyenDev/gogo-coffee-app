                ...
                <ul className="order-list">
                  <li className="order">
                    <span className="order-img">
                      ...
                      <img
                        src="https://www.caffesociety.co.uk/assets/recipe-images/cappuccino-small.jpg"
                        alt=""
                      />
                    </span>
                ...
                <ul className="tickets-list">
                  <li>
                    ...
                    <div className="ticket-creator">
                      ...
                      <span className="time-ticket-created">
                        09.08.2018 - 12:45
                      </span>
                    </div>
                  </li>
        ...
        <div className="row">
                ...
                <ul className="status-list">
                  <li>
                    <div className="status-name">
                      ...
                      <span className="float-right-text">66.6667%</span>
                    </div>
                  ...
                  <li>
                    <div className="status-name">
                      <p>Portfolio</p>
                      <span className="float-right-text">12.5%</span>
                    </div>
                    <div className="dark-grey">
                      <div
                        style={{ width: "12.5%" }}
                  ...
                  <li>
                    <div className="status-name">
                      <p>Billing Details</p>
                      <span className="float-right-text">33.3333%</span>
                    </div>
                    <div className="dark-grey">
                      <div
                        style={{ width: "33.3333%" }}
                  ...
                  <li>
                    <div className="status-name">
                      <p>Interests</p>
                      <span className="float-right-text">0%</span>
                    </div>
                    <div className="dark-grey">
                      <div
                        style={{ width: "0%" }}
                  ...
                  <li>
                    <div className="status-name">
                      <p>Legal Documents</p>
                      <span className="float-right-text">50%</span>
                    </div>
                    <div className="dark-grey">
                      <div
                        style={{ width: "50%" }}
          ...
          <div className="col-lg-4 col-md-6 mg-top">
            <div className="card banner ">
              <div className="card-body">
                <span className="brand-app">Gogo Coffee</span>
                <div className="banner-main-text">Magic is in the Details</div>
      ...
      <div className="mg-top">
        <div className="row">
          <div className="col-lg-6 col-xl-3 mg-top">
            <div className="card ">
              <div className="card-body justify-content-align">
                <div className="inline-block-flt-left">Payment Status</div>
                <div className="inline-block-flt-left">
                  <div
                    className="circle-border"
                    style={{
                      background:
                        "linear-gradient(273deg, rgb(111, 78, 55) 50%, transparent 50%), linear-gradient(-45deg, rgb(111, 78, 55) 50%, lightgray 50%)",
                    }}
                  >
          ...
          <div className="col-lg-6 col-xl-3 mg-top">
            <div className="card ">
              <div className="card-body justify-content-align">
                <div className="inline-block-flt-left">Payment Done</div>
                <div className="inline-block-flt-left">
                  <div
                    className="circle-border"
                    style={{
                      background:
                        "linear-gradient(270deg, rgb(111, 78, 55) 50%, transparent 50%), linear-gradient(18deg, rgb(111, 78, 55) 50%, lightgray 50%)",
                    }}
                  >
                    <div className="circle">
          ...
          <div className="col-lg-6 col-xl-3 mg-top">
            <div className="card ">
              <div className="card-body justify-content-align">
                <div className="inline-block-flt-left ">Tasks Done</div>
                <div className="inline-block-flt-left">
                  <div
                    className="circle-border"
                    style={{
                      background:
                        "linear-gradient(299deg, rgb(111, 78, 55) 50%, transparent 50%), linear-gradient(-88deg, rgb(111, 78, 55) 50%, lightgray 50%), linear-gradient(-88deg, lightgray 50%,transparent 50%)",
                    }}
                  >
                    <div className="circle">
          ...
          <div className="col-lg-6 col-xl-3 mg-top">
            <div className="card ">
              <div className="card-body justify-content-align">
                <div className="inline-block-flt-left ">Work Progress</div>
                <div className="inline-block-flt-left">
                  <div
                    className="circle-border"
                    style={{
                    ...
                    <div className="inline-block-flt-left">
                      <div className="circle-wrap">
                        <div className="circle">
                          ...
                          <div className="inside-circle">5/12</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="inline-block-flt-left">
                      <div className="circle-wrap">
                        <div className="circle">
                          ...
                          <div className="inside-circle">4/6</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="inline-block-flt-left">
                      <div className="circle-wrap">
                        <div className="circle">
                          ...
                          <div className="inside-circle">8/10</div>
                        </div>
                      </div>
                    </div>
                  </div>
