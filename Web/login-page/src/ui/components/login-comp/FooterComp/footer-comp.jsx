            ...
            <div className="footer-details">
              <div className="footer-info">
                <div className="brand-footer">
                  <img src={logo4} alt="" />
                  <p className="brand-title">Gogo Coffee</p>
                </div>
                <span style={{ marginRight: "10px" }}>
                  One cup of coffee in Gogo Coffee will boost your energy every
                  morning.Come and order.
                </span>
                  ...
                  <div className="row">
                    <div className="col-md-4 col-sm-12">
                      ...
                      <li className="google-play">
                        <img
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQihbMObs2stYan2aQKMttr81DBv6GVs6elSA&usqp=CAU"
                          alt=""
                        />
                      </li>
                    </div>
                    ...
                    <div className="col-md-4 col-sm-12">
                      <h3>Information:</h3>
                      <li>Page:https://www.facebook.com</li>
    ...
    <>
      <div className="copy-right">
        <div className="container">
          ...
          <label>&copy; Copy right by Gogo coffee app in 2020</label>
        </div>
      </div>
    </>
  );
